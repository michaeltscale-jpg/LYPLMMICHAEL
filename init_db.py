...
def make_default_equipment_project_plan(active_stage_idx=6):
    stages = [
        ("stage1_plan", "立项", "张工 (设备立项负责人)", -50, -45, "《设备立项可行性评估报告》.pdf", "/docs/eq_g1_deliverable.pdf"),
        ("stage2_scheme", "拟定技术方案", "李工 (工艺方案负责人)", -44, -38, "《设备技术方案规格书(正式稿)》.pdf", "/docs/eq_g2_deliverable.pdf"),
        ("stage3_bidding", "请购发包中", "王经理 (采购商务负责人)", -37, -30, "《设备采购合同与发包技术协议》.pdf", "/docs/eq_g3_deliverable.pdf"),
        ("stage4_make", "设备制作中", "刘工 (设备监造负责人)", -29, -15, "《设备出厂预验收检验核对表(FAT)》.pdf", "/docs/eq_g4_deliverable.pdf"),
        ("stage5_install", "安装调试中", "陈工 (现场安装负责人)", -14, 5, "《设备二次工程与安装自检报告(SAT)》.pdf", "/docs/eq_g5_deliverable.pdf"),
        ("stage6_accept", "验收交付使用", "赵经理 (生产验收负责人)", 6, 12, "《设备竣工综合验收签收单(正式结案)》.pdf", "/docs/eq_g6_deliverable.pdf")
    ]
    
    stage_inputs = {
        "stage1_plan": ["《新增设备开发立项申请表》.docx", "《生产/工艺扩产需求意向书》.pdf", "《厂房动能与场地现状评估报告》.xlsx", "《设备开发ROI与投资回收期分析表》.xlsx"],
        "stage2_scheme": ["《设备设计大纲与技术要求(TDS规格)》.pdf", "《设备安全与环保 SOP 标准规程》.docx", "《关键零部件与国产化替代清单》.xlsx", "《电气/PLC控制系统硬件选型表》.xlsx"],
        "stage3_bidding": ["《设备技术方案规格书(签章版)》.pdf", "《设备采购请购申请单(PR单)》.xlsx", "《合格设备供应商名录(AVL库)》.pdf", "《设备采购发包商务条款与保密协议》.docx"],
        "stage4_make": ["《设备采购商务合同与发包技术协议》.pdf", "《供应商设备制作排期甘特图(每周更新)》.xlsx", "《核心零部件进厂检验与材质证明》.pdf", "《设备出厂前FAT预验收检查表》.xlsx"],
        "stage5_install": ["《设备出厂预验收检验合格报告(FAT)》.pdf", "《二次配管配电与厂房施工对接图》.dwg", "《现场安装调试安全作业指导书(JSA)》.docx", "《冷态/热态单机与联动点动试车规程》.pdf"],
        "stage6_accept": ["《单机/联动试运转72小时连续日志》.xlsx", "《CPK/OEE 72小时连续稳定性测试原始数据》.xlsx", "《设备维护保养 SOP 与易损件备件清单》.pdf", "《操作人员/维修人员培训签到表与考核成绩》.pdf"]
    }

    stage_deliverables = {
        "stage1_plan": ["《设备立项可行性评估报告(最终签署版)》.pdf", "《设备初估成本与投资预算表》.xlsx", "《设备开发全生命周期一级排期计划》.pdf", "《设备开发项目组组建与分工表》.xlsx"],
        "stage2_scheme": ["《设备技术方案规格书(正式签章版)》.pdf", "《设备机械3D精密装配图纸与2D施工图包》.zip", "《电气原理图与PLC控制逻辑说明书》.pdf", "《设备目标成本分解与BOM明细表》.xlsx"],
        "stage3_bidding": ["《供应商技术与商务评标综合比选表》.xlsx", "《设备采购商务合同与发包技术协议》.pdf", "《采购发包实际成本与目标成本对比表》.xlsx", "《供应商现场制造与审计评估报告》.pdf"],
        "stage4_make": ["《设备制作监造与周进度跟踪报告》.pdf", "《设备出厂预验收检验合格报告(FAT)》.pdf", "《出厂合格证与机械电气随机技术资料包》.zip", "《设备运输吊装与入厂定位方案》.pdf"],
        "stage5_install": ["《单机/联动72小时试运转测试日志》.xlsx", "《设备二次工程与现场安装自检确认单(SAT)》.pdf", "《现场安装调试问题(Punch List)整改追踪表》.xlsx", "《安装调试阶段累计支出账单与核算表》.xlsx"],
        "stage6_accept": ["《设备终验合格签署单(SAT正式结案)》.pdf", "《设备转固资产移交确认卡与编号》.pdf", "《设备全生命周期实际决算与初始预算对比表》.xlsx", "《设备完整履历归档案卷总目录》.pdf"]
    }
